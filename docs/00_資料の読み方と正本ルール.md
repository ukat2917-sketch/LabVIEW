...
実装手順の記述方法は[00A_LabVIEW実装資料の記述ルール.md](./00A_LabVIEW実装資料の記述ルール.md)を正本とする。
...
03、06～12、付録A1で具体的な作業を説明する場合は、00Aの次の形式を使用する。
...
| 手順の書き方 | `00A_LabVIEW実装資料の記述ルール.md` |
...
10. ダミーデータの論理値だけでなく、生成回路と書込位置を記載する。
