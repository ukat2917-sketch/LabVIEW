...
| 15 | [docs/15_実験PC向けNIライセンス選定.md](./docs/15_実験PC向けNIライセンス選定.md) | 実験PCで行う作業別のLabVIEW・TestStandライセンスと参考費用 |
...
| ツール | [scripts/generate-ni-license-selection-diagrams.py](./scripts/generate-ni-license-selection-diagrams.py) | 実験PC向けNIライセンス選定SVGの再生成 |
